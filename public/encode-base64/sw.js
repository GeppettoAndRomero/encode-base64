...
const CACHE_NAME = 'encode-base64-v1';
const RUNTIME_CACHE = 'encode-base64-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/encode-base64/',
  '/encode-base64/manifest.json',
  '/encode-base64/icon-192.png',
  '/encode-base64/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/encode-base64/manifest.json';
}
