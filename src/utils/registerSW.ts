...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/encode-base64/sw.js, scope=/encode-base64/）。
    // scope がツールの全 locale ページ（/encode-base64/, /encode-base64/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/encode-base64/sw.js', {
      scope: '/encode-base64/',
    });
